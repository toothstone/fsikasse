...
(function ($) { // hide the namespace
    $.keypad.regionalOptions['pl'] = {
        buttonText: '...', buttonStatus: 'Pokaż klawiaturę',
        closeText: 'Zamknij', closeStatus: 'Zamknij klawiaturę',
        clearText: 'Czyść', clearStatus: 'Usuń cały tekst',
        backText: 'Del', backStatus: 'Usuń poprzedni znak',
        shiftText: 'Shift', shiftStatus: 'Duże litery / Małe litery',
